...
# url1 = 'https://backend8181.bcy.gov.vn/api/document/findDocByTypeHandle/2/1'
...
#     for name in names:
#         download_url = f'https://backend8181.bcy.gov.vn/api/attachment/download/{name}'  # Địa chỉ tải xuống
...
#             print(f'Tải xuống thành công: {name}')
#         else:
